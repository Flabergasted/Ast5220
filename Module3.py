...
ax.set_title(r"Density perturbations $\delta_b$, $\delta_{CDM}$ and $\delta_{\gamma}$")
...
fig, ax = plt.subplots()
fig.set_size_inches(10, 7.5)
ax.set_title(r"Gravitational Potential ($\Phi$)")
...
fig, ax = plt.subplots()
fig.set_size_inches(10, 7.5)
ax.set_title(r"Gravitational Potential + Curvature ($\Phi + \Psi$)")
...
fig, ax = plt.subplots()
fig.set_size_inches(10, 7.5)
ax.set_title(r"Monopole $\Theta_0$")
...
fig, ax = plt.subplots()
fig.set_size_inches(10, 7.5)
ax.set_title(r"Quadrapole $\Theta_2$")
